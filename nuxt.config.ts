...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    // SAU KHI REDIRECT ĐƯỢC docs-version.global.ts XỬ LÝ ĐỂ RA PHIÊN BẢN `LIVE` HAY `VI`
    '/docs': { redirect: '/nuxt/nuxtcore/getting-started/introduction', prerender: false },
    //link content trong /guide/index
  ...
  //link content trong /api/index
  '/docs/api/components/client-only': { redirect: '/nuxt/nuxtcore/api/components/client-only', prerender: false },
  '/docs/api/composables/use-app-config': { redirect: '/nuxt/nuxtcore/api/composables/use-app-config', prerender: false },
