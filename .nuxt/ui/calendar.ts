...
export default {
  ...
  "variants": {
    "color": {
      ...
      "important": {
        "headCell": "text-important",
        "cellTrigger": "focus-visible:ring-important data-[selected]:bg-important data-today:not-data-[selected]:text-important data-[highlighted]:bg-important/20 hover:not-data-[selected]:bg-important/20"
      },
      "neutral": {
