...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "active": false,
      "class": {
        "item": "text-important data-highlighted:text-important data-highlighted:before:bg-important/10 data-[state=open]:before:bg-important/10",
        "itemLeadingIcon": "text-important/75 group-data-highlighted:text-important group-data-[state=open]:text-important"
      }
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      ...
      "active": true,
      "class": {
        "item": "text-important before:bg-important/10",
        "itemLeadingIcon": "text-important"
      }
    }
  ],
  "defaultVariants": {
