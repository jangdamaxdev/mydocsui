...
export default {
  ...
  "variants": {
    "color": {
      ...
      "important": {
        "base": "focus-visible:outline-important",
        "indicator": "bg-important" as typeof indicator[number]
      },
      "neutral": {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "variant": "card" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:border-important"
      }
    },
    {
    ...
    },
    {
      ...
      "variant": "table" as typeof variant[number],
      "class": {
        "item": "has-data-[state=checked]:bg-important/10 has-data-[state=checked]:border-important/50 has-data-[state=checked]:z-[1]"
      }
    },
    {
      "color": "neutral" as typeof color[number],
