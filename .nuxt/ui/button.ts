...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "variant": "solid" as typeof variant[number],
      "class": "text-inverted bg-important hover:bg-important/75 active:bg-important/75 disabled:bg-important aria-disabled:bg-important focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-important"
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      "color": "important" as typeof color[number],
      "variant": "outline" as typeof variant[number],
      "class": "ring ring-inset ring-important/50 text-important hover:bg-important/10 active:bg-important/10 disabled:bg-transparent aria-disabled:bg-transparent dark:disabled:bg-transparent dark:aria-disabled:bg-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-important"
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      "color": "important" as typeof color[number],
      "variant": "soft" as typeof variant[number],
      "class": "text-important bg-important/10 hover:bg-important/15 active:bg-important/15 focus:outline-none focus-visible:bg-important/15 disabled:bg-important/10 aria-disabled:bg-important/10"
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      "color": "important" as typeof color[number],
      "variant": "subtle" as typeof variant[number],
      "class": "text-important ring ring-inset ring-important/25 bg-important/10 hover:bg-important/15 active:bg-important/15 disabled:bg-important/10 aria-disabled:bg-important/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-important"
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      "color": "important" as typeof color[number],
      "variant": "ghost" as typeof variant[number],
      "class": "text-important hover:bg-important/10 active:bg-important/10 focus:outline-none focus-visible:bg-important/10 disabled:bg-transparent aria-disabled:bg-transparent dark:disabled:bg-transparent dark:aria-disabled:bg-transparent"
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      "color": "important" as typeof color[number],
      "variant": "link" as typeof variant[number],
      "class": "text-important hover:text-important/75 active:text-important/75 disabled:text-important aria-disabled:text-important focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-important"
    },
    {
