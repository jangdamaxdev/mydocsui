...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "variant": "solid" as typeof variant[number],
      "class": {
        "root": "bg-important text-inverted"
      }
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "outline" as typeof variant[number],
      "class": {
        "root": "text-important ring ring-inset ring-important/25"
      }
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "soft" as typeof variant[number],
      "class": {
        "root": "bg-important/10 text-important"
      }
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      ...
      "variant": "subtle" as typeof variant[number],
      "class": {
        "root": "bg-important/10 text-important ring ring-inset ring-important/25"
      }
    },
    {
