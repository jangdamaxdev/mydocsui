...
export default {
  ...
  "variants": {
    ...
    "color": {
      ...
      "important": {
        "indicator": "group-data-[state=completed]:bg-important group-data-[state=active]:bg-important"
      },
      "neutral": {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "reverse": false,
      "class": {
        "separator": "group-data-[state=completed]:bg-important"
      }
    },
    {
      "color": "primary" as typeof color[number],
    ...
    },
    {
      ...
      "reverse": true,
      "class": {
        "separator": "group-data-[state=active]:bg-important group-data-[state=completed]:bg-important"
      }
    },
    {
