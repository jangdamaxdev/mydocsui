...
export default {
  ...
  "compoundVariants": [
    ...
    },
    {
      ...
      "class": "has-focus-visible:ring-2 has-focus-visible:ring-important"
    },
    {
    ...
    },
    {
      ...
      "class": "focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-important"
    },
    {
      "color": "primary" as typeof color[number],
      "highlight": true,
    ...
    },
    {
      "color": "important" as typeof color[number],
      "highlight": true,
      "class": "ring ring-inset ring-important"
    },
    {
      "color": "neutral" as typeof color[number],
      "variant": [
